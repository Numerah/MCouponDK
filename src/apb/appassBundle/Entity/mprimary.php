...
class mprimary
{
     ...
     * @var \Date
     * @ORM\Column(name="coupon_primary_field_value_date", type="date", length=255, nullable=true)
     */
     ...
     * @Gedmo\Timestampable(on="create")
     * @var \Time
     * @ORM\Column(name="coupon_primary_field_value_time", type="time", length=255, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="coupon_primary_field_number_value", type="string", length=255, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="coupon_primary_field_currency_value", type="string", length=255, nullable=true)
     */
     ...
     *
     * @param string $couponPrimaryFieldNumberValue
     *
     * @return mprimary
     */
     ...
     *
     * @param string $couponPrimaryFieldCurrencyValue
     *
     * @return mprimary
     */
