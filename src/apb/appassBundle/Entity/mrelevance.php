...
class mrelevance
{
     ...
     * @var \Date
     *
     * @ORM\Column(name="coupon_relevance_location_date", type="date", length=255, nullable=true)
     */
     ...
     * @Gedmo\Timestampable(on="create")
     * @var \Time
     * @ORM\Column(name="coupon_relevance_location_time", type="time", length=255, nullable=true)
     */
